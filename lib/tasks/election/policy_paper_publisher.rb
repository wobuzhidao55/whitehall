...
module Election
      ...
      @policy_paper_ids.each do |policy_paper_id|
        if policy_paper = Publication.find_by(id: policy_paper_id)
          if policy_paper.published?
            ...
            raise "What should we set this public timestamp to?"
  ...
  private
    ...
    def historical_change_note
      "Worldwide priority document from the 2010 to 2015 government preserved in a different format for reference"
    end
